        ...
        <fragment className="flex flex-col justify-center items-center min-h-screen p-5 gap-5">
            ...
            <main className="flex flex-col gap-5">
                ...
                <div>
                    ...
                    <input id="email" className="w-full border-1 rounded-md pl-5 py-4" type="text" placeholder="email@company.com" />
                    <br />
                </div>

                <button type="submit" className="w-full bg-slate-800 rounded-md py-4 text-white font-medium">Subscribe to monthly newsletter</button>
